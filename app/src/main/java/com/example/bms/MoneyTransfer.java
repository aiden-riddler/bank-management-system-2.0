...
public class MoneyTransfer extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayAdapter = new ArrayAdapter<>(MoneyTransfer.this, R.layout.list_item, accountsList);
    ...
    private void validateInput() {
        ...
        } else if (user.getPhone().equals("+254" + phone.trim())) {
            cancel = true;
            focusView = phoneView;
            phoneView.setError("You cannot transfer money to your own account");
        }
        ...
        if (cancel)
            ...
            FundsTransferController.makeTransfer(accountNumber, amountToBePaid, "+254" + phone.trim(), MoneyTransfer.this, progressCard, progressText, transfer, user, accountDialog, customer);
        }
    }
...
//        super.onBackPressed();
        Intent intent = new Intent(MoneyTransfer.this, CustomerPanel.class);
